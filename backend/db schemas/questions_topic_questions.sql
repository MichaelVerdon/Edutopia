...
VALUES 
  ...
  (9, 'What are the primary characteristics of IBM Engineering and Science Subroutine Library (ESSL)?', 'Security, reliability, and scalability', 'Performance, functional capability, and usability', 'Flexibililty, compatibility, and portability', 'Cost-effectiveness, simplicity, and integration', 'Performance, functional capability, and usability')
  (9, 'What is IBM Rational Developer for i designed for?', 'Manageing IBM hardware configurations', 'Creating and maintaining applications for IBM', 'Performing data analysis and visualization on IBM systems', 'Running virtual machines on IBM systems', 'Creating and maintaining applications for IBM'),
  (9, 'What is IBM XL Fortran for Linux', 'An Operating System', 'A IDE', 'Data analysis software', 'High-performance compiler', 'High-performance compiler'),
